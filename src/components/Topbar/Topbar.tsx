  ...
  return (
    <nav className="relative flex h-[50px] w-full shrink-0 items-center px-5 bg-dark-layer-1 text-dark-gray-2">
      <div className="flex w-full items-center justify-between max-w-[1200px] mx-auto">
        ...
        {/* Additional function for problem page topbar */}
        {problemPage && (
          <div className="flex items-center gap-4 flex-1 justify-center">
            <div className="flex items-center justify-center bg-dark-fill-3 hover:bg-dark-fill-2 h-8 w-8 cursor-pointer">
              <FaChevronLeft />
            </div>
            <Link
              href="/"
        ...
        {/* problem page topbar(additional part) ends here */}
